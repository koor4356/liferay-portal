...
<liferay-util:buffer var="linkTemplate">
	<a class="{cssClass}" data-url="{url}" data-uuid="{uuid}" href="{regularURL}" id="{id}" title="{title}">{label}</a>

	<a data-url="{url}" data-uuid="{uuid}" href="{layoutURL}" id="{id}" title="<liferay-ui:message arguments="{title}" key="edit-x" />"><span class="icon-cog icon-monospaced"></span></a>
</liferay-util:buffer>
